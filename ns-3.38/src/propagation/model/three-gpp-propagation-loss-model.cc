                                            ...
                                            double hBs) const
{
    ...
    //Free Space Model for LOS integrated
    loss = 20*log10(distance2D) +20*log10(m_frequency)-147.55;
                                             ...
                                             double hBs) const
{
    ...
    double loss = 34.36*log10(distance2D) +7.83 * hUt - 4.0*log10(distance2D * hUt) +17.59;
