...
struct UlGrant_s
{
    ...
    uint64_t m_Framenumber{UINT16_MAX};
    uint8_t m_Subframenumber{UINT8_MAX};
    uint8_t m_Slotnumber{UINT8_MAX};
    uint8_t m_StartSymbol{UINT8_MAX};
    uint8_t m_NumberSymbols{UINT8_MAX};
