...
void
Asn1Header::SerializeBitstring(std::bitset<24> data) const
{
...
void
Asn1Header::SerializeBitstring(std::bitset<40> data) const
{
...
Buffer::Iterator
Asn1Header::DeserializeBitstring(std::bitset<24>* data, Buffer::Iterator bIterator)
{
...
Buffer::Iterator
Asn1Header::DeserializeBitstring(std::bitset<40>* data, Buffer::Iterator bIterator)
{
