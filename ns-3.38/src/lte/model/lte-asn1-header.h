...
class Asn1Header : public Header
{
  ...
  protected:
     ...
     * \returns the modified buffer iterator
     */
     Buffer::Iterator DeserializeBitstring(std::bitset<24>* bitstring, Buffer::Iterator bIterator);
    /**
     * Deserialize a bitstring
     * \param bitstring buffer to store the result
     * \param bIterator buffer iterator
     ...
     * \returns the modified buffer iterator
     */
    Buffer::Iterator DeserializeBitstring(std::bitset<40>* bitstring, Buffer::Iterator bIterator);
