...
class LteMacSapProvider
{
  public:
    ...
    virtual void TransmitMsg3(TransmitPduParameters params) = 0;
    ...
    virtual std::unordered_map<uint8_t, LteMacSapProvider::ReportBufferStatusParameters> GetBufferStatus() =0;
...
EnbMacMemberLteMacSapProvider<C>::GetBufferStatus()
{
    NS_FATAL_ERROR("Should not be called for a BS");
}

template <class C>
void
EnbMacMemberLteMacSapProvider<C>::TransmitMsg3(TransmitPduParameters params)
{
   NS_FATAL_ERROR("TransmitMsg3 was used for a BS");
}
