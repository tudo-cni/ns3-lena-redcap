...
class UeMemberLteUeCmacSapProvider : public LteUeCmacSapProvider
{
  public:
    ...
    void StartContentionBasedRandomAccessProcedure(bool redcap, bool sdt) override;
...
void
UeMemberLteUeCmacSapProvider::StartContentionBasedRandomAccessProcedure(bool redcap, bool sdt)
{
    m_mac->DoStartContentionBasedRandomAccessProcedure(redcap,sdt);
}
...
{
   NS_FATAL_ERROR("ActivateBwp shouldnt be used for LTE");
}

void
UeMemberLteUeCmacSapProvider::DeactivateBwp(LteNrTddSlotType type)
{
   NS_FATAL_ERROR("DeactivateBwp shouldnt be used for LTE");
}

void
UeMemberLteUeCmacSapProvider::NotifyDrx(uint frames)
{
   NS_FATAL_ERROR("NotifyDrx not implemented for LTE");
}

void
UeMemberLteUeCmacSapProvider::NotifyeDrx(uint frames)
{
   NS_FATAL_ERROR("NotifyeDrx not implemented for LTE");
}

void
UeMemberLteUeCmacSapProvider::SetPRnti(uint16_t prnti)
{
   NS_FATAL_ERROR("SetPRnti not implemented for LTE");
}
...
void
UeMemberLteMacSapProvider::TransmitMsg3(TransmitPduParameters params)
{
   NS_FATAL_ERROR("TransmitMsg3 not implemented for LTE");
}
...
UeMemberLteMacSapProvider::GetBufferStatus()
{
    NS_FATAL_ERROR("Not implemented for LTE");
}
...
void
LteUeMac::DoStartContentionBasedRandomAccessProcedure(bool redcap, bool sdt)
{
    NS_LOG_FUNCTION(this);
