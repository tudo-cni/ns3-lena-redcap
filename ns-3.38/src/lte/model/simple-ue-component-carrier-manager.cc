...
class SimpleUeCcmMacSapProvider : public LteMacSapProvider
{
  public:
    ...
    void TransmitMsg3(LteMacSapProvider::TransmitPduParameters params) override;
...
SimpleUeCcmMacSapProvider::GetBufferStatus()
{
    NS_FATAL_ERROR("This should not be called.");
}

void
SimpleUeCcmMacSapProvider::TransmitMsg3(TransmitPduParameters params)
{
...
void
SimpleUeComponentCarrierManager::DoTransmitMsg3(LteMacSapProvider::TransmitPduParameters params)
{
    NS_LOG_FUNCTION(this);
    std::map<uint8_t, LteMacSapProvider*>::iterator it =
        m_macSapProvidersMap.find(params.componentCarrierId);
...
LteMacSapProvider*
SimpleUeComponentCarrierManager::DoGetLteMacSapProvider(uint8_t bwpID)
{
    return m_macSapProvidersMap.at(bwpID);
}
...
void
SimpleUeComponentCarrierManager::DoStartBwpSwitching(uint8_t bwpID)
{
    NS_FATAL_ERROR("Not implemented here");
}

void
SimpleUeComponentCarrierManager::SetBwpInactivityTimer(Time inactTimer)
{
    NS_FATAL_ERROR("Not implemented here");
}

void
SimpleUeComponentCarrierManager::DoRefreshBwpInactivityTimer()
{
    NS_FATAL_ERROR("Not implemented here");
}
