...
void
EnbMacMemberLteEnbCmacSapProvider::ScheduleAckDci( uint16_t rnti)
{
    NS_FATAL_ERROR("Not implemented for LTE");
}

void
EnbMacMemberLteEnbCmacSapProvider::addPaging( uint16_t prnti)
{
    NS_FATAL_ERROR("Not implemented for LTE");
}

void
EnbMacMemberLteEnbCmacSapProvider::addEdrx( uint32_t rf, uint16_t rnti)
{
    NS_FATAL_ERROR("Not implemented for LTE");
}

std::tuple<uint8_t,uint8_t>
EnbMacMemberLteEnbCmacSapProvider::GetMcs( uint16_t rnti)
{
    NS_FATAL_ERROR("Not implemented for LTE");
}

void
EnbMacMemberLteEnbCmacSapProvider::SetMcs( uint16_t rnti, std::tuple<uint8_t,uint8_t> mcsTuple)
{
    NS_FATAL_ERROR("Not implemented for LTE");
}
...
class EnbMacMemberLteEnbPhySapUser : public LteEnbPhySapUser
{
  public:
    ...
    void ReceiveRachPreamble(uint32_t prachId, uint8_t occasion) override;
...
void
EnbMacMemberLteEnbPhySapUser::ReceiveRachPreamble(uint32_t prachId, [[maybe_unused]] uint8_t occasion)
{
    m_mac->DoReceiveRachPreamble(prachId, occasion);
}
...
void
LteEnbMac::DoReceiveRachPreamble(uint8_t rapId, [[maybe_unused]]  uint8_t occasion )
{
