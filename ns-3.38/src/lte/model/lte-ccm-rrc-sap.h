...
class LteCcmRrcSapProvider
{
  ...
  public:
    ...
    virtual void UpdateActiveBwpMap(uint16_t rnti, uint8_t bwp) = 0;

    virtual LteMacSapProvider* GetLteMacSapProvider(uint8_t bwp) = 0;
...
class MemberLteCcmRrcSapProvider : public LteCcmRrcSapProvider
{
  public:
    ...
    void UpdateActiveBwpMap(uint16_t rnti, uint8_t bwp) override;
    LteMacSapProvider* GetLteMacSapProvider(uint8_t bwp)override;
...
template <class C>
void
MemberLteCcmRrcSapProvider<C>::UpdateActiveBwpMap(uint16_t rnti, uint8_t bwp)
{
    return m_owner->DoUpdateActiveBwpMap(rnti, bwp);
}


template <class C>
LteMacSapProvider*
MemberLteCcmRrcSapProvider<C>::GetLteMacSapProvider( uint8_t bwp)
{
    return m_owner->GetLteMacSapProvider( bwp);
}
...
class MemberLteCcmRrcSapUser : public LteCcmRrcSapUser
{
  public:
    ...
    void NotifySwitchedBwp(uint8_t bwpID);
...
template <class C>
void
MemberLteCcmRrcSapUser<C>::NotifySwitchedBwp(uint8_t bwpID)
{
    return m_owner->DoNotifySwitchedBwp(bwpID);
}
