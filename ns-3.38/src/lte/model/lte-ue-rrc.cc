...
{
    NS_FATAL_ERROR("LTE has no Bwps. This function should not be called");
}
...
void
LteUeRrc::DoNotifyRandomAccessSuccessful(UlGrant_s grant, bool sdt)
{
    ...
    case IDLE_RANDOM_ACCESS: {
        ...
        int64_t sendTime = grant.m_Framenumber*10+grant.m_Subframenumber; //TODO genaue Zeitpunkt mit Numerology bestimmen
        Time delay = MilliSeconds(sendTime-Simulator::Now().GetMilliSeconds());
        NS_ASSERT(delay.GetMilliSeconds()>0);
        
        Simulator::Schedule(delay,&LteUeRrc::StartSendRrcConnectionRequest,this,msg);
    }
    break;
...
void
LteUeRrc::DoNotifySwitchedBwp(uint8_t bwpID)
{
   NS_FATAL_ERROR("LteUeRrc shouldnt use this method");
}
...
LteUeRrc::StartConnection()
{
    ...
    m_cmacSapProvider.at(0)->StartContentionBasedRandomAccessProcedure(false, false);
}
...
void
LteUeRrc::StartSendRrcConnectionRequest( LteRrcSap::RrcConnectionRequest msg)
{
