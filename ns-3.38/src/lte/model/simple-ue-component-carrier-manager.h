...
class SimpleUeComponentCarrierManager : public LteUeComponentCarrierManager
{
  ...
  protected:
    ...
    virtual void DoStartBwpSwitching(uint8_t bwpID);
    virtual void SetBwpInactivityTimer(Time inactTimer);
    virtual void DoRefreshBwpInactivityTimer();

    virtual LteMacSapProvider* DoGetLteMacSapProvider(uint8_t bwpID);
