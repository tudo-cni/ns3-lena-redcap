...
class NrUecphySapProvider
{
  public:
    ...
    virtual void InsertMsg3Allocation(SfnSf sfnsf, std::shared_ptr<DciInfoElementTdma>& dci) = 0;

    virtual void ActivateBwp(LteNrTddSlotType type) =0;
    virtual void DeactivateBwp(LteNrTddSlotType type) =0;
...
class NrUeCphySapUser
{
  public:
    ...
    virtual void SendRrcConnectionRequest() = 0;
...
class MemberNrUecphySapProvider : public NrUecphySapProvider
{
  public:
    ...
    void InsertMsg3Allocation(SfnSf sfnsf, std::shared_ptr<DciInfoElementTdma>& dci) override;
...
template <class C>
void
MemberNrUecphySapProvider<C>::StartInSnycDetection()
{
...
template <class C>
void 
MemberNrUecphySapProvider<C>::InsertMsg3Allocation(SfnSf sfnsf, std::shared_ptr<DciInfoElementTdma>&  dci)
{
    m_owner->DoInsertMsg3Allocation(sfnsf,dci);
}

template <class C>
void
MemberNrUecphySapProvider<C>::ActivateBwp(LteNrTddSlotType type)
{
    m_owner->DoActivateBwp(type);
}

template <class C>
void
MemberNrUecphySapProvider<C>::DeactivateBwp(LteNrTddSlotType type)
{
    m_owner->DoDeactivateBwp(type);
}
...
class MemberNrUeCphySapUser : public NrUeCphySapUser
{
  public:
    ...
    void SendRrcConnectionRequest() override;
...
template <class C>
void
MemberNrUeCphySapUser<C>::SendRrcConnectionRequest()
{
    m_owner->DoSendRrcConnectionRequest();
}
