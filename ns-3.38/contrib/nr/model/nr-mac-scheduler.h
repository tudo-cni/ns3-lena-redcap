...
class NrMacScheduler : public Object
{
  public:
    ...
    virtual std::tuple<uint8_t, uint8_t> DoGetMcs(uint16_t rnti) = 0;
    
    virtual void DoSetMcs(uint16_t rnti, std::tuple<uint8_t, uint8_t> mcsTuple) = 0;

    virtual void DoSetSchedulerPrachConfig(NrPhySapProvider::PrachConfig prachConfig) = 0;
    ...
    virtual void DoSchedUlMsg3InfoReq(
        const NrMacSchedSapProvider::SchedUlMsg3InfoReqParameters& params) = 0;
    /**
