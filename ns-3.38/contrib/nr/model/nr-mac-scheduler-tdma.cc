...
NrMacSchedulerTdma::BeamSymbolMap
NrMacSchedulerTdma::AssignULRBG_manager(uint32_t symAvail, const ActiveUeMap& activeUl, const SfnSf& ulSfn) 
{
    NS_LOG_FUNCTION(this);
    BeamSymbolMap x;
    return x; //function not used
}

NrMacSchedulerTdma::BeamSymbolMap
NrMacSchedulerTdma::AssignDLRBG_manager(uint32_t symAvail, const ActiveUeMap& activeDl, const SfnSf& dlSfn) 
{
    NS_LOG_FUNCTION(this);
    BeamSymbolMap x;
    return x; //function not used
