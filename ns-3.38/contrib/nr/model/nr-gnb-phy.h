...
class NrGnbPhy : public NrPhy
{
  ...
  public:
     ...
     */
    void SetEnbCphySapUser(NrGnbCphySapUser* s);
    /**
     * \brief Get the C PHY SAP provider
     * \return the C PHY SAP provider pointer
     */
    NrGnbCphySapProvider* GetEnbCphySapProvider();
