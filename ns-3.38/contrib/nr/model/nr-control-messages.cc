...
void
NrRachPreambleMessage::SetRachOccasion(uint8_t occasion)
{
    m_occasion = occasion;
}

void
NrRachPreambleMessage::SetPrachNumber(uint32_t prachNumber)
{
    m_prachNumber = prachNumber;
}

void
NrRachPreambleMessage::SetImsi(uint16_t imsi)
{
    m_imsi = imsi;
}
...
uint8_t
NrRachPreambleMessage::GetOccasion() const
{
    return m_occasion;
}

uint32_t
NrRachPreambleMessage::GetPrachNumber() const
{
    return m_prachNumber;
}

uint16_t
NrRachPreambleMessage::GetImsi() const
{
    return m_imsi;
}
...
NrPagingMessage::NrPagingMessage()
{
    SetMessageType(NrControlMessage::PAGING);
}
...
void
NrPagingMessage::SetPRnti(uint16_t pRnti)
{
    m_pRnti = pRnti;
}

uint16_t
NrPagingMessage::GetPRnti() const
{
    return m_pRnti;
}
