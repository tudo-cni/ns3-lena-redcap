...
class BwpManagerGnb : public RrComponentCarrierManager
{
  public:
    ...
    /**
     * \brief Get the active bwp index for the RNTI
     * \param rnti The RNTI of the user
     * \return The index of the BWP which is currently active
     */
    uint8_t GetActiveBwp(uint16_t rnti);

    /**
     * \brief Update the active BWP
     * \param rnti The RNTI of the user
     * \param bwpID new active BWP index
     */
    void UpdateActiveBwpMap(uint16_t rnti, uint8_t bwpID);
