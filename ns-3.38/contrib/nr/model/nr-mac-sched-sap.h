...
class NrMacSchedSapProvider
{
  public:
    ...
    struct SchedUlSrInfoReqParameters
    {
     ...
     /**
     * \brief Information element for scheduler 
     */
    struct SchedUlMsg3InfoReqParameters
    {
        SfnSf m_snfSf;                  //!< SnfSf in which the sr where received
        std::vector<uint16_t> m_msg3List; //!< List of RNTI which want to transmit Msg3
    };
    ...
    virtual void SchedUlMsg3InfoReq(const SchedUlMsg3InfoReqParameters& params) = 0;
...
class NrMacSchedSapUser
{
  public:
     ...
     * \return number of coreset symbols
     */
